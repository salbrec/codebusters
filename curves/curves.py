...
if '-test' in argv:
	n_est = 20
clfs = []
clf1 = GradientBoostingClassifier(random_state=0, n_estimators=n_est, learning_rate=0.18)
clfs.append(('Gradient Boosting', clf1))
clf2 = RandomForestClassifier(random_state=0, max_depth=17, n_estimators=n_est) # approx: 0.75
